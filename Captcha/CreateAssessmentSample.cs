...
namespace Captcha
{
    ...
    public class CreateAssessmentSample
    {
        ...
        public void createAssessment(string projectID = "rogergmailapp", string recaptchaKey = "6LdIHoApAAAAAPwCW5-GidmCeQlpc5ZjgN323rm-", string token = "action-token", string recaptchaAction = "action-name")
        {
